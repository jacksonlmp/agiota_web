'use client'
import { cadastrarCliente, carregarCliente } from "@/app/lib/funcoes";
import { useState, useEffect } from "react";
import DatePicker from 'react-datepicker';
import 'react-datepicker/dist/react-datepicker.css';
import { format, parse } from 'date-fns';

export default function AtualizarCliente({params}) {
 const [formData, setFormData] = useState(
  ...
  useEffect(()=>{
    const loadForm = async () => {
        carregarCliente(params.id)
            .then(response => {     
                const unFormattedData = {
                  ...response,
                  nascimento: response.nascimento ? parse(response.nascimento, 'dd/MM/yyyy', new Date()) : null,
                }; 
